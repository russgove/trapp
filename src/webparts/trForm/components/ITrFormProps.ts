...
export interface ITrFormProps {
  ...
  save: (tr: TR, originalAssignees: Array<number>,originalStaffCCs:Array<number>, originalStatus: string,originalRequiredDate:string) => Promise<any>; //make this return promise // method to call to save tr
